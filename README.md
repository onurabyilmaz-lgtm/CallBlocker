...
Gelen aramaları otomatik reddeden ve arayan kişiye SMS gönderen Android uygulaması.
...
1. Uygulamayı aç
2. Switch'i aktif et
3. Kişi listesine engellemek istediğin kişileri ekle
...
| İzin | Neden |
|------|-------|
| Telefon Durumu | Gelen aramaları tespit eder |
| Aramayı Bitir | Aramayı reddeder |
| SMS Gönder | Otomatik mesaj atar |
